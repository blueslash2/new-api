...
func TextHelper(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.NewAPIError) {
	...
	// ========== 执行所有的请求修改操作 ==========
	// 包括：Moonshot temperature处理、tool_calls格式转换、工具参数补全、extra_body注入
	helper.ProcessAllRequestModifications(c, info, request)
	// ========== 请求修改操作结束 ==========
	...
	if passThroughGlobal || info.ChannelSetting.PassThroughBodyEnabled {
		...
		helper.LogTruncatedRequestBody(jsonData, info.ChannelId, request.Model)
		// ========== 日志代码结束 ==========
